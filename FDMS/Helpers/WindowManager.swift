...
class WindowManager: NSObject {
    ...
    func pushSearchViewController(_ controller: UIViewController, textTitle: String, otherObject: [OtherObject],
        ...
        searchViewController.delegate = controller as? InfoSearchRequestDelegate
